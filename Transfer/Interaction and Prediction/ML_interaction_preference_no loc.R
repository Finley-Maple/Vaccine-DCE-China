...
apollo_control <- list(
  ...
  nCores = 36 # use the number of cores
)
# ####################################################### #
#### 2. Data loading                                   ####
# ####################################################### #
...
# )
# save(fit, "ML_interaction_preference_space.RData")
apollo_loadModel("Mixed logit model including interactions_model.rds")

load("ML_interaction_preference_space.RData") # we only need to load after estimation
# ####################################################### #
#### 8. Model prediction for specific vaccine                ####
# ####################################################### #
...
vaccine_Kexing_0 = list(price = "0", risk = "1/1,000,000", duration = "6 months", efficacy = "50%", admin = "Injection", doses = "2 doses", origin = "Domestic")
