...
pacman::p_load("maps", "mapdata", "maptools", "ggplot2", "mapproj", 
               "rgdal", "reshape2", "Hmisc", "jtools", "pscl", "aod", "gpclib")

# packages for merging the plots
...
if (Sys.info()[['sysname']] == "Windows"){
  font_add("Times New Roman", regular = "times.ttf", bold = "timesbd.ttf", italic = "timesi.ttf", bolditalic = "timesbi.ttf") # for Windows
  }
if (Sys.info()[['sysname']] == "Darwin"){
  font_add("Times New Roman", "times.ttc") # for Mac
}
...
#### 2.4.3 Figure 1: Visualization of the interaction effects

```{r Figure 1 Visualization of the interaction effects}
showtext_auto()

c_Attribute = c("b_price", "b_risk3", "b_risk2", "b_duration2", "b_duration3", "b_efficacy2", "b_efficacy3", "b_oral", "b_dose3", "b_imported")
...
# merge the plots into one figure
# List of EPS files to merge
# eps_files <- c("Figure/ML_interaction_effects_b_price.eps", "Figure/ML_interaction_effects_b_risk2.eps", "Figure/ML_interaction_effects_b_risk3.eps", "Figure/ML_interaction_effects_b_duration2.eps", "Figure/ML_interaction_effects_b_duration3.eps", "Figure/ML_interaction_effects_b_efficacy2.eps", "Figure/ML_interaction_effects_b_efficacy3.eps", "Figure/ML_interaction_effects_b_oral.eps", "Figure/ML_interaction_effects_b_dose3.eps", "Figure/ML_interaction_effects_b_imported.eps")

labels <- c("A  Price", "B  Moderate risk", "C  High risk", "D  Moderate protection duration (12 months)", "E  Long protection duration (Life long)", "F  Moderate efficacy (70% efficacy)", "G  High efficacy (90% efficacy)", "H  Oral administration", "I  Three doses", "J  Imported")

# # Function to convert magick image to ggplot object
# image_to_ggplot <- function(image, label) {
#   ggplot() +
#     annotation_custom(rasterGrob(image, interpolate = TRUE), xmin = -Inf, xmax = Inf, ymin = -Inf, ymax = Inf) +
#     ggtitle(label) +
#     theme_void() +
#     theme(plot.title = element_text(hjust = 0.5, size = 15))
# }
# 
# # Read EPS files as images and convert to ggplot objects
# image_ggplots <- mapply(function(file, label) {
#   image <- image_read(file)
#   image_to_ggplot(image, label)
# }, eps_files, labels, SIMPLIFY = FALSE)

# Combine images into a single plot with labels
combined_image <- plot_grid(plotlist = image_list, ncol = 2, labels = labels, label_fontfamily = "Times New Roman", label_size = 15, hjust = -1.5, vjust =  0)


print(combined_image)
# Save the labeled combined image to a file
ggsave("Figure/combined_figure1_with_labels.pdf", plot = combined_image, device = "pdf", width = 16, height = 22, dpi = 300, limitsize = FALSE, units = "in")
...
#### 3.1 Figure 4: Subgroup analysis- Sinovac vaccine with different price
...
## Appendix Table 1: Mixed logit model
...
###  Report the basic model results (Appendix Table S1)
...
# Appendix Table 2: Report the relative importance
...
## Appendix Table 3: Relative importance of the attributes
