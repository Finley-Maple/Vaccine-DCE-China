...
combined_image <- plot_grid(plotlist = image_list, ncol = 2, labels = labels, label_fontfamily = "Times New Roman", label_fontface = "bold", label_size = 15, label_x = 0.5, label_y = 1, hjust = 0.5, vjust =  c(1.5, 1.5, 0, 0, 0, 0, 0, 0, 0, 0))

print(combined_image)
# Save the labeled combined image to a file
ggsave("Figure/combined_figure1_with_labels.eps", plot = combined_image, device = "eps", width = 16, height = 22, dpi = 400, limitsize = FALSE, units = "in")
...
for (i in 1:length(vaccine_price)) {
  ...
  map<-ggplot() + # base map
    geom_sf(data = data_merge, aes(fill = uptake_rate*100)) + # province 
    coord_sf() +  # projection way
  ...
  map_list = append(map_list, list(map))
}


# Combine images into a single plot with labels
combined_image <- plot_grid(plotlist = map_list, ncol = 2)

print(combined_image)
# Save the labeled combined image to a file
ggsave("Figure/combined_figure4.eps", plot = combined_image, device = "eps", width = 16, height = 20, dpi = 400, limitsize = FALSE, units = "in")
